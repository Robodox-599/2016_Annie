...
#define REDUCTION							    (.5)
#define DEADZONE								(0.2) //(.15) the joystick axis can be go up to 0.17 at its resting state. Update 2016/01/14: It was 0.2 the left joystick was extremely sensitive
