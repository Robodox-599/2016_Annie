...
float LinearDrive::CalculateRotValue(float angle, float speed)
{
...
void LinearDrive::setAdjYaw(float offset)
{
	yawOffset = offset;
}

void LinearDrive::setIsRotDone(bool isDone)
{
	isRotDone = isDone;
}

void LinearDrive::setIsRotDoneOverride(bool isDone)
{
	isRotDoneOverride = isDone;
}

void LinearDrive::setTimesThroughLoop(int timeLoop)
{
	timesThroughLoop = timeLoop;
}

float LinearDrive::getImuYaw()
{
	return imuYaw;
}

bool LinearDrive::getisRotDone()
{
	return isRotDone;
}

bool LinearDrive::getisRotDoneOverride()
{
